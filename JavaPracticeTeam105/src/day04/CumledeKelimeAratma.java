...
public class CumledeKelimeAratma {
    public static void main(String[] args) {
        ...
        System.out.println("lütfen  cumlede aratmak istenilen kelimeyi giriniz");
 ...
 if ( sayac>1){
     System.out.println("Cümlede  " + sayac + "  kadar " + kelime+" var");
 } else if (sayac==1) {
     System.out.println("cümlede 1 adet "  + kelime+ "  var");
 }else System.out.println("aradıgınız kelime cümlede bulunmamaktadır");
    }
